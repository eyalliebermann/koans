...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    ## inject supplies an inital vslue and then does than accumulates the action over all items - same as js reduce function
  end
  ...
  ## I guess calling the block acepting open method also closes the file after the block is excuted
